        ...
        <div className='flex flex-col gap-1 my-3'>
          <div className='flex flex-col justify-between lg:flex-row gap-2'>
            <div className='flex flex-col mb-3 space-y-2 w-[100%]'>
              ...
              })} type='text' placeholder='Name' className='focus:outline-none rounded-xl bg-slate-100 px-3 py-2 border w-full text-sm focus:ring-2' />
              {errors?.name && <p className='text-sm text-red-500 pl-3'>{errors.name.message}</p>}
            </div>
          </div>
          <div className='flex flex-col mb-3 space-y-2'>
            ...
            })} type='text' placeholder='Email' className='focus:outline-none rounded-xl bg-slate-100 px-3 py-2 border text-sm focus:ring-2' />
          ...
          <div className='flex flex-col mb-3 space-y-2'>
            ...
            })} type='text' placeholder='Phone' className='focus:outline-none rounded-xl bg-slate-100 px-3 py-2 border text-sm focus:ring-2' />
            {errors?.phone && <p className='text-sm text-red-500 pl-3'>{errors.phone.message}</p>}
          </div>
          <div className='flex flex-col justify-between lg:flex-row gap-2'>
            <div className='flex flex-col mb-3 space-y-2 w-[100%]'>
              <label className='text-sm font-semibold pl-3'>
              ...
              <input {...register('address', {
                required: 'This field is required'
              })} type='text' placeholder='Address' className='focus:outline-none rounded-xl bg-slate-100 px-3 py-2 border w-full text-sm focus:ring-2' />
              {errors?.address && <p className='text-sm text-red-500 pl-3'>{errors.address.message}</p>}
            </div>
          </div>
          <div className='flex flex-col justify-between lg:flex-row gap-2'>
            <div className='flex flex-col mb-3 space-y-2 w-[100%]'>
              ...
              <input {...register('classroom', {
                required: 'This field is required'
              })} type='text' placeholder='Class' className='focus:outline-none rounded-xl bg-slate-100 px-3 py-2 border w-full text-sm focus:ring-2' />
              {errors?.classroom && <p className='text-sm text-red-500 pl-3'>{errors.classroom.message}</p>}
            </div>
          </div>
          <div className='flex flex-col justify-between lg:flex-row gap-2'>
            <div className='flex flex-col mb-3 space-y-2 w-[100%]'>
              ...
              <input {...register('faculty', {
                required: 'This field is required'
              })} type='text' placeholder='Faculty' className='focus:outline-none rounded-xl bg-slate-100 px-3 py-2 border w-full text-sm focus:ring-2' />
              {errors?.faculty && <p className='text-sm text-red-500 pl-3'>{errors.faculty.message}</p>}
            </div>
          </div>
          <div className='flex flex-col justify-between lg:flex-row gap-2'>
            <div className='flex flex-col mb-3 space-y-2 w-[100%]'>
              ...
              <input {...register('university', {
                required: 'This field is required'
              })} type='text' placeholder='University' className='focus:outline-none rounded-xl bg-slate-100 px-3 py-2 border w-full text-sm focus:ring-2' />
              {errors?.university && <p className='text-sm text-red-500 pl-3'>{errors.university.message}</p>}
            </div>
          </div>
